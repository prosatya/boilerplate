...
class Boilerplate {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $boilerplate    The string used to uniquely identify this plugin.
	 */
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-Boilerplate-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-Boilerplate-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-Boilerplate-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-Boilerplate-public.php';
	...
	private function set_locale() {
		...
		$plugin_i18n->set_domain( $this->get_Boilerplate() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Boilerplate_Public( $this->get_Boilerplate(), $this->get_version() );
	 ...
	 */
	public function get_Boilerplate() {
